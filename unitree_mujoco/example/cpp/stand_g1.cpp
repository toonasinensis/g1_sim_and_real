...
private:
    double stand_up_joint_pos[29] = {0.00571868, 0.608813, -1.21763, -0.00571868, 0.608813, -1.21763,
                                     0.00571868, 0.608813, -1.21763, -0.00571868, 0.608813, -1.21763};
    double stand_down_joint_pos[29] = {0.0473455, 1.22187, -2.44375, -0.0473455, 1.22187, -2.44375, 0.0473455,
...
void Custom::LowStateMessageHandler(const void *message)
{
    ...
    //  if (low_state.crc() != crc32_core((uint32_t *)&low_state, (sizeof(unitree_hg::msg::dds_::LowState_) >> 2) - 1)) {
    // //   std::cout << "[ERROR] CRC Error" << std::endl;
    //   return;
    // }
   std::cout<<low_state.motor_state().at(0).q();
    // std::cout<<low_state<<std::endl;
}
